...
import fr.insalyon.creatis.boutiques.model.OutputFile;
...
public class BoutiquesService {
    ...
    public BoutiquesDescriptor parseFile(String boutiquesDescriptorFile) throws BoutiquesException {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(new File(boutiquesDescriptorFile), BoutiquesDescriptor.class);
        } catch (IOException e) {
            throw new BoutiquesException("Error parsing boutiques file " + boutiquesDescriptorFile, e);
        }
    }
